...
public class TestRolDao {
	...
	public void insert() throws SQLException{
		Rol rol = new Rol("È¾ºìËêÔÂ","firstrole","666666","849740574@qq.com","¸Ð¾õ×Ô¼ºÃÈÃÈßÕ",picdao.queryById(41),regdao.queryById(142),ocpdao.queryById(21),100,eqtdao.queryById(0));
		roldao.insert(rol);
	}
